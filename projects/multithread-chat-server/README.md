...
동일 조건의 Multi 구성에서 5,000·10,000·15,000명 모든 구간의 Recv·Send TPS가 높아지고 평균 응답 지연이 낮아졌습니다. Accept TPS는 5,000명과 10,000명 구간에서는 낮았고, 15,000명 구간에서 높았습니다. 단일 Content Queue의 직렬 처리가 병목에 영향을 주고 있음을 확인했습니다. 대신 `SessionID % 4` 방식은 Thread별 부하가 고르게 분산된다는 보장이 없다는 비용이 남습니다.
